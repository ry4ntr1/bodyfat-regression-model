...
class DataIngestionConfig:
    ...
    logging.info("DataIngestionConfig Instance Initialized")

class DataIngestion:
    def __init__(self):
        self.ingestion_config = DataIngestionConfig()
        logging.info("DataIngestion Instance Initialized")

    def initiate_data_ingestion(self):
        try:
            logging.info("initiate_data_ingestion() called")
            ...
            logging.info("initiate_data_ingestion() finished")
...
if __name__ == "__main__":
    ...
    logging.info("__main__ finished")
