...
class DataIngestionConfig:
    ...
    logging.info("data_ingestion.py: DataIngestionConfig Instance Initialized")
...
class DataIngestion:
    def __init__(self):
        ...
        logging.info("data_ingestion.py: DataIngestion Instance Initialized")

    def initiate_data_ingestion(self):
        try:
            logging.info("data_ingestion.py: initiate_data_ingestion() called")
            ...
            logging.info(
                "data_ingestion.py: initiate_data_ingestion() finished")
...
if __name__ == "__main__":
    logging.info("data_ingestion.py: __main__ called")
    obj = DataIngestion()
    ...
    # print(score)
    logging.info("data_ingestion.py: __main__ finished")
